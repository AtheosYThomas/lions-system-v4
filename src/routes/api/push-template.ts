 ...
 */
router.post('/save', authMiddleware, requireAnyRole([Role.Admin, Role.President]), async (req, res) => {
  try {
 ...
 */
router.post('/test', authMiddleware, requireAnyRole([Role.Admin, Role.President]), async (req, res) => {
  try {
 ...
 */
router.get('/list', authMiddleware, requireAnyRole([Role.Admin, Role.President]), async (req, res) => {
  try {
 ...
 */
router.get('/:id', authMiddleware, requireAnyRole([Role.Admin, Role.President]), async (req, res) => {
  try {
    const { id } = req.params;
